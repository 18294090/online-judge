...
class DevelopmentConfig(Config):
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get('TEST_DATABASE_URL') or "mysql://root:123@127.0.0.1:3306/ojdb"
...
class ProductionConfig(Config):
    SQLALCHEMY_DATABASE_URI = os.environ.get('TEST_DATABASE_URL') or "mysql://root:123@127.0.0.1:3306/web"
